...
This project heavily adopts the boiler plate in [this repo](https://github.com/hagopj13/node-express-boilerplate) using a [PostgreSQL](https://www.postgresql.org) database with [Prisma](https://www.prisma.io) ORM.

## Quick Start

1. Ensure your node is on `v20.10.0`. You should use `nvm` to manage your node version.
2. Clone the repo:

```bash
git clone git@github.com:GDSC-NUS/care2give-be-cms.git
cd care2give-be-cms
```
...
- [Care2Give Backend](#care2give-backend)
