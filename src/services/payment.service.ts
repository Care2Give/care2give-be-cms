...
const updatePaymentIntent = async (
  ...
  updateParams: Stripe.PaymentIntentUpdateParams
): Promise<void> => {
  try {
...
const handleWebhookEvent = async (
  ...
  switch (event.type) {
    case "payment_intent.created":
      ...
      console.log("[LOG] PaymentIntent was created!", "id: ", paymentIntent.id);
      paymentStatus = PaymentStatus.CREATED;
      break;
    case "payment_intent.succeeded":
      console.log("[LOG] PaymentIntent was successful!");
      paymentStatus = PaymentStatus.SUCCEEDED;
      break;
    case "payment_intent.payment_failed":
      console.log("[LOG] Payment failed!");
      paymentStatus = PaymentStatus.FAILED;
      break;
    case "payment_intent.canceled":
      console.log("[LOG] Payment cancelled!");
